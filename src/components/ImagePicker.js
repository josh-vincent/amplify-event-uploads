...
export default function ImagePicker({onSubmit, onSelect}) {
    ...
    <section class="overflow-hidden text-gray-700">
       <div class="container py-2 mx-auto pt-12 lg:pt-24 lg:px-32 flex flex-row align-middle justify-center ">
          <input class="w-1/2 inline-block mx-2 px-6 py-2.5 bg-gray-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md" type="file" multiple accept="image/png, image/gif, image/jpeg" onChange={ (e) => handleChange(e.target.files) } />
